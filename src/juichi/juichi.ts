...
export function create(defaults: Options = {}): Juichi {
  const juichi = function juichi(url, opts: Options = {}) {
  ...
  juichi.get = (url, options) => juichi(url, withMethod(options, "GET"));
  juichi.post = (url, options) => juichi(url, withMethod(options, "POST"));
  juichi.put = (url, options) => juichi(url, withMethod(options, "PUT"));
  juichi.delete = (url, options) => juichi(url, withMethod(options, "DELETE"));
  juichi.patch = (url, options) => juichi(url, withMethod(options, "PATCH"));
  juichi.create = create;
